...
const MANDATORY_SKILL_NOTICE = `<mandatory-skill>
Mandatory project skill for this repository:
- Invoke \`project-docker-guard\` before making any code/config/schema changes.
- Re-check \`project-docker-guard\` before finishing your final answer.
</mandatory-skill>`
...
Read and follow all instructions below carefully.
  ...
  parts.push(MANDATORY_SKILL_NOTICE)
